# Documentation Contract: Vision-Language-Action Module Standards

## Purpose
This document defines the standards and patterns for creating consistent, high-quality documentation for the Vision-Language-Action module (VLA) in the Physical AI & Humanoid Robotics course.
...
- Code snippets MUST be in Python, TypeScript/JavaScript, XML, YAML, or other appropriate languages for the tools
...
- Configuration files (e.g., YAML, launch files) MUST be properly formatted
...
- All configuration examples MUST be tested in the appropriate environment
...
- Maintain consistency with Modules 1-3
- Highlight API key requirements and rate limits where applicable
- Reference official Whisper, ROS, and LLM provider documentation