# Documentation Contract: AI-Robot Brain Module Standards

## Purpose
This document defines the standards and patterns for creating consistent, high-quality documentation for the AI-Robot Brain module (NVIDIA Isaac™) in the Physical AI & Humanoid Robotics course.
...
- Code snippets MUST be in TypeScript/JavaScript, Python, XML, YAML, or other appropriate languages for the Isaac tools
...
- All configuration examples MUST be tested in the appropriate Isaac/Nav2 environment
...
- Maintain consistency with Modules 1-2
- Highlight GPU requirements where applicable
- Reference official NVIDIA Isaac Sim/ROS and Nav2 documentation